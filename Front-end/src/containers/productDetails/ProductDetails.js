              ...
              <Container>
                ...
                <div className="product-content-bottom">
                  ...
                  <TabContent activeTab={this.state.activeTab}>
                      ...
                      <div className="tab-content" id="myTabContent">
                        ...
                        >
                          ...
                          <div className="product-info-box border-top border-bottom mt-5  pt-4 pt-lg-0 pb-2 pb-sm-0">
                            <Row>
                              <Col sm={6} md={4}>
                                <div className="webhype_info_box_2 webhype_info_box_2-layout-style_2 webhype_info_box_2-content_alignment-left webhype_info_box_2-with-icon webhype_info_box_2-icon-source-font  webhype_info_box_2-icon-size-md  webhype_info_box_2-icon_position-left icon-left-spacing">
                                  <div className="webhype_info_box_2-inner clearfix align-items-center">
                                    <div className="webhype_info_box_2-icon">
                                      <div className="webhype_info_box_2-icon-wrap">
                                        <div className="webhype_info_box_2-icon-outer">
                                          <div className="webhype_info_box_2-icon-inner">
                                            <i className="glyph-icon pgsicon-ecommerce-delivery-truck-1" />{" "}
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                    <div className="webhype_info_box_2-content">
                                      <div className="webhype_info_box_2-content-wrap">
                                        <div className="webhype_info_box_2-content-inner">
                                          <h6 className="webhype_info_box_2-title inline_hover">
                                            Free shipping{" "}
                                          </h6>
                                          <div className="webhype_info_box_2-content">
                    ...
                    <TabPane tabId="3">
                      <p>
                        The Crochet-Shoulder Chevron Sweatshirt ipsum dolor sit
                        amet, consectetur adipisicing elit. Tenetur, libero,
                        ratione. Tenetur dolor vitae voluptatem, earum nam,
                        voluptas culpa ex vel et aliquid aperiam pariatur ad hic
                        commodi, dicta tempora.
                      </p>
                      <p>
                        Wearing a sweatshirt in public doesn’t mean you can’t
                        look put-together doing it. The Crochet-Shoulder Chevron
                        Sweatshirt from Knox Rose is slightly more tailored for
                        a pullover, though it still gives you a loose fit that
                        remains comfortable and flexible as you move. The
                        textured fabric is enhanced with crochet sleeve details.
                        Throw this long-sleeve sweatshirt over a pair of jeans
                  ...
                  {/* <div className="related products">
                    ...
                    <div className="row">
                      <ProductSlider
                        productSub={Productedit.subcategory}
